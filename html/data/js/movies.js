...
function createTopCard(movie) {
  return '<div class="top-card">' +
    ...
    '<div class="top-card-body">' +
      ...
      '<div class="top-card-meta">' + movie.year + ' &mdash; ' + (movie.episodes ? movie.episodes + ' eps &mdash; ' : '') + movie.type + '</div>' +
...
async function buildPage() {
  ...
  // New to Movies
  const newMovies = filtered.filter(function(m) { return m.new; }).slice(0, 6);
